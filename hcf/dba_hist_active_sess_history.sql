 ...
 * =============================================================================================
 * @param   sql_id          (VARCHAR2)   Стартовый снепшот генерации отчета
 * @param   plan_hash_value (NUMBER)     Конечный снепшот генерации отчета
 * @param   format          (VARCHAR2)   Конечный снепшот генерации отчета
 * =============================================================================================
 * Описание полей:
